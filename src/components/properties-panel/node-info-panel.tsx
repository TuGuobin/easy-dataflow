...
export const NodeInfoPanel = ({ selectedNode, onTitleChange, themeConfig }: NodeInfoPanelProps) => {
  ...
  return (
    <div className="mb-5">
      ...
      <div className="mb-2">
        <Select label={t("propertiesPanel.nodeType")} options={[{ label: nodeName, value: nodeName }]} value={nodeName} clearable={false} themeConfig={themeConfig} disabled={!selectedNode} />
      </div>
      <div className="mb-2">
